...
map.getView().fit([499045.146939, 5147851.352976, 2309067.595670, 7144716.912659], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Thematic Partnerships of the UAEU</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (186 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map contains all the members across thematic partnerships of the Urban Agenda for the EU. Layers can be toggled on/off in the legend in the top right corner. <br />Author: Patrick Smith ';
            }
